...
function IconCalendar() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#16A34A] shrink-0">
    ...
    <section className="relative bg-white pt-24 pb-14 md:pt-28 md:pb-16 overflow-hidden">
      ...
      <div className="relative max-w-[1100px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-[0.9fr_1.1fr] gap-8 md:gap-10 items-center max-w-[950px] mx-auto">
          ...
          <div className="rounded-2xl border-2 border-[#111827] bg-white p-6 md:p-7">
            <span className="inline-block px-3 py-1 rounded-full bg-[#111827] text-white text-xs font-bold uppercase mb-4">
              2 Hour Online Session
            </span>
            <div className="grid grid-cols-2 gap-4 mb-5">
              <div>
                <div className="flex items-center gap-1.5 text-[#16A34A] text-xs font-bold uppercase mb-1">
                  <IconCalendar /> Date
                </div>
    ...
    <section className="relative bg-[#F0FDF4] py-12 md:py-16 overflow-hidden">
      ...
      <div className="relative max-w-[1000px] mx-auto px-6">
        ...
        <p className="text-[#4B5563] text-center mb-10 max-w-2xl mx-auto">
          You're probably only thinking about one of these right now. The answer still shapes what you learn, what you go after, and how you prepare.
        </p>
    ...
    <section className="relative bg-white py-12 md:py-16 overflow-hidden">
      ...
      <div className="relative max-w-[1100px] mx-auto px-6">
        ...
        <p className="text-[#4B5563] text-center mb-8">
          For ECE, EEE, EIE, BME, Mechatronics, and related electronics branches.
        </p>
        <div className="text-center">
...
function FoundationCoursesSlider() {
  ...
  return (
    <div className="relative mt-6">
      <div ref={trackRef} className="flex gap-5 overflow-x-auto snap-x snap-mandatory pb-4" style={{ scrollbarWidth: "none" }}>
        {cgFoundationCourses.map((course) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <span className="text-4xl font-extrabold text-[#E5E7EB]" style={{ fontFamily: "var(--font-headline, var(--font-display))" }}>
    ...
    <section id="register" className="relative bg-white py-12 md:py-16 overflow-hidden">
      ...
      <div className="relative max-w-[1100px] mx-auto px-6">
        <div className="rounded-2xl border-2 border-[#111827] bg-white p-6 md:p-10">
          ...
          <p className="text-center text-[#111827] font-semibold text-lg mb-2">All 10 Foundation Courses Included</p>
          <FoundationCoursesSlider />

          <div className="text-center mt-10">
            <p className="font-bold text-[#16A34A] mb-1" style={{ fontFamily: "var(--font-headline, var(--font-display))", fontSize: "48px" }}>
              Rs. {cgOffer.price}
            </p>
