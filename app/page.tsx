  ...
  return (
    <section className="mx-auto w-full max-w-5xl px-4 pb-8 sm:px-6">
      <TrackedLink
        ...
        className="group relative block overflow-hidden rounded-[24px] border border-amber-400/50 bg-gradient-to-r from-amber-50 via-yellow-50 to-amber-50 px-5 py-5 shadow-[0_16px_45px_rgba(15,23,42,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_20px_55px_rgba(15,23,42,0.12)] sm:px-7 sm:py-6"
      >
        <div
          aria-hidden="true"
