    ...
    >
      ...
      <div className="overflow-hidden rounded-2xl bg-[#0A3D1F]">
        ...
        <div className="grid grid-cols-1 gap-0 border-t border-white/10 sm:grid-cols-2">
          {/* Starter */}
          <div className="relative flex flex-col gap-4 border-b border-white/10 p-6 sm:border-b-0 sm:border-r sm:p-8">
            <div>
              <p className="text-[10px] font-extrabold uppercase tracking-[0.13em] text-white/50">
                Starter Plan
              </p>
              <p className="mt-0.5 text-xs text-white/40">1 month access · All 10 courses</p>
            </div>
            ...
            <div className="flex items-baseline gap-2.5">
              ...
              <span className="text-lg text-white/35 line-through">₹{STARTER_ORIGINAL}</span>
              <span className="ml-auto rounded-full bg-white/10 px-2.5 py-0.5 text-[10px] font-bold text-white/60">
                ≈₹{STARTER_PER_DAY}/day
              </span>
            </div>
            ...
            <a
              ...
              className="mt-auto block rounded-xl border border-white/20 bg-white/10 py-3 text-center text-sm font-black text-white transition hover:bg-white/18"
            >
          ...
          <div className="relative flex flex-col gap-4 p-6 sm:p-8">
            {/* Best Value badge */}
            <div className="absolute right-5 top-5 rounded-full bg-[#FFC400] px-2.5 py-0.5 text-[9px] font-extrabold uppercase tracking-[0.1em] text-[#0A3D1F] sm:right-6 sm:top-6">
              BEST VALUE
            </div>
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-white/40">6 months access · All 10 courses + extras</p>
            </div>
            ...
            <div className="flex items-baseline gap-2.5">
              ...
              <span className="text-lg text-white/35 line-through">₹{SEMESTER_ORIGINAL.toLocaleString("en-IN")}</span>
              <span className="ml-auto rounded-full bg-[#FFC400]/20 px-2.5 py-0.5 text-[10px] font-bold text-[#FFC400]">
                ≈₹{SEMESTER_PER_DAY}/day
              </span>
            </div>

            <p className="text-[11px] font-semibold text-[#FFC400]">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto block rounded-xl border-2 border-[#FFC400] bg-[#FFC400] py-3 text-center text-sm font-black text-[#0A3D1F] shadow-[0_3px_0_rgba(0,0,0,0.3)] transition hover:-translate-y-0.5 hover:bg-amber-300 active:translate-y-0.5 active:shadow-none"
            >
        ...
        <div className="border-t border-white/10 px-6 py-5 sm:px-8">
          <p className="text-[10px] font-extrabold uppercase tracking-[0.13em] text-white/40">
            How to redeem
          </p>
