    ...
    <footer className="border-t border-slate-200 bg-[#0A3D1F]">
      ...
      <div className="mx-auto max-w-6xl px-5 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Individual Courses */}
          <div>
            <h3 className="text-[10px] font-extrabold uppercase tracking-[0.14em] text-emerald-400">
              Individual Courses
            </h3>
            <p className="mt-0.5 text-[10px] text-emerald-200/50">3-month access · ₹319 each</p>
              ...
              {individualCourses.map((c) => (
                <li key={c.number}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-start gap-2 text-sm text-emerald-200/70 transition hover:text-white"
                  >
          ...
          <div>
            ...
            <p className="mt-0.5 text-[10px] text-emerald-200/50">All 10 courses included</p>
            <ul className="mt-4 space-y-4">
              <li>
                ...
                >
                  <p className="text-[10px] font-extrabold uppercase tracking-wider text-emerald-300">Starter · 1 Month</p>
              ...
              <li>
                <a
                  ...
                  className="text-sm font-semibold text-emerald-300 transition hover:text-white"
                >
          ...
          <div>
            ...
            <p className="mt-0.5 text-[10px] text-emerald-200/50">Live online workshops</p>
            <div className="mt-4">
              <a
              ...
              >
                <span className="inline-flex rounded-full bg-emerald-500/20 px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-wider text-emerald-300">
                  Upcoming
                </span>
                <p className="mt-2 text-sm font-bold leading-snug text-white">
                  Resume Preparation for Core Electronics Jobs
                </p>
                <p className="mt-1.5 text-[11px] text-emerald-200/60">Sunday, August 16, 2026</p>
                <p className="text-[11px] text-emerald-200/60">11 AM to 1 PM IST · ₹80</p>
            ...
            <div className="mt-5">
              <p className="text-xs text-emerald-200/50">More workshops to be announced.</p>
              <a
                href={site.linkedin}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-1 block text-xs font-semibold text-emerald-300 transition hover:text-white"
              >
        ...
        <div className="mt-12 flex flex-col items-center gap-4 border-t border-white/10 pt-7 sm:flex-row sm:justify-between">
          <nav className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-xs font-semibold text-emerald-200/50 sm:justify-start">
          ...
          <div className="text-center text-xs text-emerald-200/40 sm:text-right">
            <p>© {new Date().getFullYear()} eTalVis. All rights reserved.</p>
            <p className="mt-0.5">
              Built by{" "}
              <a href="https://www.linkedin.com/in/raghavkanva/" target="_blank" rel="noopener noreferrer" className="font-semibold text-emerald-300/60 hover:text-white transition">
                Raghav Kanva
              </a>
            </p>
          </div>
